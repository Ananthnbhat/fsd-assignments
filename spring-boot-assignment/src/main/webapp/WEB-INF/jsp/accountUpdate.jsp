  ...
  <body>
    ...
    <div class="container">
        ...
        <form:form method="POST" modelAttribute="userForm" class="form-signin">
            ...
            <span class="alert alert-info"><c:out value="${sessionScope.statusMessage}"/></span>
            <span class="alert alert-danger"> <c:out value="${sessionScope.SPRING_SECURITY_LAST_EXCEPTION}"/></span>
            <spring:bind path="username">
                <div class="form-group ${status.error ? 'has-error' : ''}">
                    <form:input type="text" path="username" class="form-control" placeholder="Username" autofocus="true" readonly="true"></form:input>
